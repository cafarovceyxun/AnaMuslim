...
object Keys {
    // Reader keys used by ActivityChapInfo, ChapterInfoCard, etc.
    ...
    const val READER_KEY_AUTO_SCROLL_STEP = "reader.auto_scroll_step"
    const val READER_KEY_TRANSL_HIGHLIGHT_PARENTHESES = "reader.transl_highlight_parentheses"
    const val READER_KEY_TRANSL_SHOW_PARENTHESES = "reader.transl_show_parentheses"
