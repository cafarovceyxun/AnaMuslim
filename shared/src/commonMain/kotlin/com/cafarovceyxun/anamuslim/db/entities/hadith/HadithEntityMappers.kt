...
fun HadithVolume.toEntity() = HadithVolumeEntity(slug, name, name_ar, author, description, updated_at)
fun HadithVolumeEntity.toModel() = HadithVolume(slug, name, name_ar, author, description, updated_at)

fun HadithBook.toEntity() = HadithBookEntity(slug, volume_slug, book_no, name, name_ar, updated_at)
fun HadithBookEntity.toModel() = HadithBook(slug, volume_slug, book_no, name, name_ar, updated_at)

fun HadithChapter.toEntity() = HadithChapterEntity(slug, book_slug, chapter_no, name, name_ar, updated_at)
fun HadithChapterEntity.toModel() = HadithChapter(slug, book_slug, chapter_no, name, name_ar, updated_at)

fun HadithSubChapter.toEntity() = HadithSubChapterEntity(slug, chapter_slug, sub_chapter_no, name, name_ar, updated_at)
fun HadithSubChapterEntity.toModel() = HadithSubChapter(slug, chapter_slug, sub_chapter_no, name, name_ar, updated_at)
