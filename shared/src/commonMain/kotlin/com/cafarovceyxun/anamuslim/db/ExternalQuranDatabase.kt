...
import com.cafarovceyxun.anamuslim.db.dao.TajweedDao
...
@Database(
    entities = [
        ...
        TajweedWordColorEntity::class,
        TajweedOverrideEntity::class,
        TajweedMetaEntity::class,
    ],
    version = 5,
    exportSchema = false,
)
...
abstract class ExternalQuranDatabase : RoomDatabase() {
    ...
    abstract fun tajweedDao(): TajweedDao
}
