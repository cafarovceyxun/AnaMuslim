...
fun ChapterNavigatorList(
    ...
    LaunchedEffect(activeChapterNo) {
        if (selectedChapterNo == null) {
            selectedChapterNo = activeChapterNo
        }
    }
    ...
    Row() {
        ...
        ChapterVerseList(
            currentChapter = selectedChapterNo?.let { surahs.getOrNull(it - 1) }?.surah,
            ...
            LazyColumn(
                ...
                items(filteredAyahs) { verseNo ->
                    Card(
                        ...
                        Text(
                            stringResource(Res.string.strLabelVerseNo, verseNo),
                            modifier = Modifier
                                .clickable {
