...
/**
 * What the index overflow menu can do. The three store hand-offs are **nullable on purpose**: they
...
data class IndexMenuActions(
    ...
    /** Sharing needs a link to share, so this is a store hand-off too — see [onRateApp]. */
