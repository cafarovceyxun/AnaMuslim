...
class QuranApp : Application() {
    ...
    override fun onCreate() {
        ...
        // The two remaining Android-only touchpoints of the shared TranslationViewModel: the
        // WorkManager-backed search index, and the force-refetch flag kept in SharedPreferences.
        ...
        com.cafarovceyxun.anamuslim.utils.managers.TranslationPlatformHooks.getFetchTranslationsForce = {
            com.cafarovceyxun.anamuslim.utils.sharedPrefs.SPAppActions.getFetchTranslationsForce(applicationContext)
        }
        com.cafarovceyxun.anamuslim.utils.managers.TranslationPlatformHooks.setFetchTranslationsForce = { force ->
            com.cafarovceyxun.anamuslim.utils.sharedPrefs.SPAppActions.setFetchTranslationsForce(applicationContext, force)
        }
